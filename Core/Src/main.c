...
//	MoveServo(&engine, SERVO_ARM2, 112, 1);
//	HAL_Delay(1000);
//	EngineMoveAccel(&engine, -120, 50, 0, 0);
//	EngineMoveAccel(&engine, 35, 50, 0, 0);
//	EngineRotateAccel(&engine, 80,  1, 90);
//	EngineMoveAccel(&engine, -363, 150, 0, 0);
//	EngineMoveAccel(&engine, 150, 150, 0, 0);
//	EngineRotateAccel(&engine, 40, 0, 90);
//	EngineMoveAccel(&engine, 300, 100, 0, 1);
//	EngineRotateAccel(&engine, 25, 1, 90);
//	EngineMoveAccel(&engine, 600, 100, 1, 0);
...
//	EngineRotateAccel(&engine, 90, 1, 90);
//	MoveServo(&engine, SERVO_ARM2, 55, 1);
//	HAL_Delay(1000);
//	EngineMoveAccel(&engine, -150, 100, 0, 0);
//	EngineMoveAccel(&engine, 150, 100, 0, 0);
//	EngineRotateAccel(&engine, 90, 0, 90);
//	EngineMoveAccel(&engine, 250, 100, 1, 0);
//	EngineMoveAccel(&engine, 300, 50, 0, 1);
//	EngineRotateAccel(&engine, 180, 0, 90);
//	EngineMoveAccel(&engine, -400, 100, 0, 0);
//	EngineMoveAccel(&engine, 118, 100, 0, 0);
//	EngineRotateAccel(&engine, 92, 1, 90);
//	EngineMoveAccel(&engine, -260, 100, 0, 0);
//	HAL_Delay(800);
//	MoveServo(&engine, SERVO_ARM2, 115, 1);
//	HAL_Delay(800);
//	EngineMoveAccel(&engine, -200, 100, 0, 0);
...
//	EngineMoveAccel(&engine, -250, 100, 0, 0);
//	MoveServo(&engine, SERVO_ARM2, 117, 1);
//	HAL_Delay(800);
//	EngineMoveAccel(&engine, 600, 50, 1, 1);
//	EngineMoveAccel(&engine, 60, 50, 0, 0);
//	EngineTurnAccel(&engine, 100,  200, 90);


//	EngineFral(&engine, 60, 50, 0, 0);
